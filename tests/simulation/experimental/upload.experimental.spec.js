/**
 * MomenPix — Upload Simulation Tests — EXPERIMENTAL (Non-blocking CI)
 * tests/simulation/experimental/upload.experimental.spec.js
 *
 * NON-BLOCKING: Runs in CI but does not block merge on failure.
 * Reason: IDB state management depends on canCaptureNow() which requires event setup.
 *
 ...
 *
 * How to run locally:
 *   npx playwright test tests/simulation/experimental/upload.experimental.spec.js --config=playwright.config.js
 */
