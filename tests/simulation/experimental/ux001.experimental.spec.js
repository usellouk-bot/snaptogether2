/**
 * MomenPix — UX-001 Lightbox Simulation Tests — EXPERIMENTAL (Non-blocking CI)
 * tests/simulation/experimental/ux001.experimental.spec.js
 *
 * Covers:
 ...
 * Reason: Tests require access to internal let variables (_lbDisplayPhotos, etc.)
 * which are not accessible from page.evaluate in the current architecture.
 * Will be unblocked when Test API (window.__MP_TEST_API__) is implemented.
 *
 * Run:
 *   npx playwright test tests/simulation/experimental/ux001.experimental.spec.js -c playwright.simulation.config.js
 */
